  ...
  },
  {
    ...
    courseAssignments: [
      ...
      },
      {
        ...
        editions: ["Edición Primavera 2025"],
      },
    ],
  },
] as const;
...
export const demoAdminCourses = [
  ...
  },
  {
    ...
    slug: "comunicacion-aumentativa-alternativa",
    shortDescription:
      "Sistemas de apoyo para mejorar comprension, expresion y participacion.",
    priceInCents: 22000,
    status: "ACTIVE",
    modules: 10,
    editions: 1,
  ...
  },
  {
    ...
    slug: "ajustes-razonables-aula",
    shortDescription:
      "Orientaciones practicas para inclusion real en entornos educativos.",
    priceInCents: 14900,
    status: "INACTIVE",
    modules: 6,
    editions: 1,
...
export const demoAdminAuditLogs = [
  ...
  },
  {
    ...
    metadata: {
      selectedCourseIds: [
        "demo-course-acompanamiento",
        "demo-course-conductual",
      ],
    },
  },
  {
...
export const demoAdminSupervisionRows = [
  ...
  },
  {
    ...
    courseTitle: "Ajustes razonables en el aula",
    editionLabel: "Edición Primavera 2025",
    status: "EXPIRED",
    accessState: "expired",
    accessUntil: new Date("2025-06-20T18:00:00.000Z"),
    completionRate: 95,
