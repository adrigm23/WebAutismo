...
export const courses: Course[] = [
  defineCourse({
    ...
    title:
      "Nociones básicas sobre apoyo conductual positivo para profesionales",
    shortDescription:
    ...
    modules: [
      {
        ...
        description:
          "Que es el apoyo conductual positivo y por que cambia la intervencion.",
      ...
      },
      {
        ...
        description:
          "Como observar, registrar y entender el por que de la conducta.",
      ...
      },
      {
        ...
        description:
          "Adaptaciones, anticipacion, entorno y ensenanza de habilidades.",
      ...
      },
      {
        ...
        description:
          "Casos de uso y decisiones practicas para contextos reales.",
        estimatedTime: "45 minutos",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "No. Los videos se visualizan en streaming desde la plataforma para proteger el contenido.",
      },
      {
        question: "Recibire un correo al comprar?",
        answer:
          "Si. Recibiras un correo de confirmacion con acceso directo y siguientes pasos.",
      },
    ],
    teacher: {
      name: "Equipo de Formación de Autismo Córdoba",
  ...
  defineCourse({
    ...
    description:
      "Formación orientada a profesionales y familias que necesitan mejorar la intención comunicativa y la comprensión del entorno.",
    priceInCents: 6900,
  ...
  defineCourse({
    ...
    faq: [
      {
        ...
        answer:
          "Si, los principios son transferibles y los ejemplos cubren varias etapas.",
      },
    ],
    teacher: {
    ...
    seoDescription:
      "Formación online para docentes sobre adaptaciones en el aula para estudiantes con autismo.",
  }),
];

const courseBySlug = new Map(
  courses.map((course) => [course.slug, course] as const),
);
