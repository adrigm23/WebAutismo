  ...
  return (
    <Card className="rounded-[2rem] p-7" id="create-course">
      ...
      <p className="mt-3 text-sm leading-7 text-[#5f7083]">
        Crea la ficha base del curso, su precio y una primera edicion activa. Despues podras
        completar modulos, asignar docentes y ajustar el contenido desde el detalle del curso.
      </p>
