        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <h1 className="max-w-4xl font-display text-5xl leading-[1.02] tracking-[-0.06em] text-[var(--color-ink)] sm:text-6xl">
              Formación especializada en autismo con compra directa, campus
              privado y un recorrido de acceso claro.
            </h1>
            <p className="max-w-2xl text-lg leading-8 text-[var(--color-muted)]">
              {siteConfig.name} reune catalogo, checkout y area privada en una
              sola plataforma. El objetivo es simple: explicar bien cada curso,
              facilitar la compra y proteger el contenido para familias,
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <Card className="p-5">
              ...
              <p className="mt-2 text-sm leading-7 text-[var(--color-muted)]">
                Fichas completas, metadata y rutas pensadas para descubrimiento
                real.
              </p>
            </Card>
            <Card className="p-5">
              ...
              <p className="mt-2 text-sm leading-7 text-[var(--color-muted)]">
                El acceso se controla desde tu cuenta segun matricula y ventana
                vigente.
              </p>
            </Card>
            <Card className="p-5">
            ...
            <div className="grid-mesh rounded-[28px] border border-white/70 bg-[linear-gradient(135deg,#0d6356,#e88564)] p-6 text-white">
              <div className="max-w-sm space-y-4">
                ...
                <p className="text-sm leading-7 text-white/82">
                  El producto prioriza compra clara, acceso real al contenido,
                  progreso manual verificable y foro privado por curso.
                </p>
              </div>
            </div>
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="rounded-[24px] bg-white p-4">
                    ...
                    <p className="mt-3 text-sm leading-7 text-[var(--color-muted)]">
                      Resumen del curso, progreso manual, materiales y acceso al
                      foro privado desde la misma cuenta.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mb-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-3">
            ...
            <h2 className="font-display text-4xl text-[var(--color-ink)]">
              Catálogo orientado a decisión y confianza
            </h2>
          </div>
          <p className="max-w-2xl text-sm leading-7 text-[var(--color-muted)]">
            Cada curso se presenta con informacion util: enfoque, destinatarios,
            programa, metodologia, docente y una llamada a la accion clara.
          </p>
        </div>
        ...
        <Card className="grid gap-8 p-8 lg:grid-cols-[0.95fr_1.05fr] lg:p-10">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-7 text-[var(--color-muted)]">
              La plataforma evita maquetas enganiosas y prioriza informacion
              fiable, acceso controlado y una navegacion clara entre cuenta,
              cursos y foro.
            </p>
          </div>
          <div className="space-y-4">
